...
class TeamMemberResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Tim Irban Tiga';

    protected static ?string $modelLabel = 'anggota tim';

    protected static ?string $pluralModelLabel = 'Tim Irban Tiga';
    ...
    {
        return ['full_name', 'nip', 'position'];
    }

    public static function getNavigationBadge(): ?string
    {
        return (string) SibatigMetrics::get('team_active');
    }
